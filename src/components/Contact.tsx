...
const socials = [
  { name: 'GitHub', href: 'https://github.com/F3lipe9' },
  { name: 'LinkedIn', href: 'https://www.linkedin.com/in/felipe-venda/' },
  { name: 'Email', href: 'mailto:fvenda@terpmail.umd.edu' }
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 max-w-5xl mx-auto">
          ...
          >
            <div className="border-b border-gray-200 pb-5">
              ...
              <div className="text-xl font-medium" style={{ color: 'var(--text-color)' }}>fvenda@terpmail.umd.edu</div>
            </div>

            <div className="pb-5">
              <div className="text-sm uppercase tracking-wider mb-3" style={{ color: 'var(--text-secondary)' }}>Location</div>
              <div className="text-xl font-medium" style={{ color: 'var(--text-color)' }}>Tampa, FL</div>
            </div>
          </motion.div>
