...
const AllProjects = () => {
  return (
    <div className="min-h-screen pt-[150px] pb-[100px]">
      <div className="max-w-5xl mx-auto px-5">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-bold mb-5" style={{ color: 'var(--text-color)' }}>All Projects</h1>
          <p className="text-xl max-w-2xl mx-auto mb-8" style={{ color: 'var(--text-secondary)' }}>
            A comprehensive collection of my work across web development, data analysis, and design
          </p>
          <Link
            to="/"
            className="inline-block transition-colors duration-300 text-lg font-medium hover:opacity-70"
